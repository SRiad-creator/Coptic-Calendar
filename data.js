...
const CALENDAR_DATA = [
    ...
    // ============================================================
    {
        ...
        feasts: [
            ...
            { day: 14, type: 'c', name: 'St. Basil the Great', icon: 'st_basil' },
    ...
    // ============================================================
    {
        ...
        feasts: [
            ...
            { day: 21, type: 'c', name: 'Fr. Pishoy Kamel', icon: 'fr_pishoy_kamel_v2' },
    ...
    // ============================================================
    {
        ...
        feasts: [
            ...
            { day: 15, type: 'c', name: 'St. Athanasius the Apostolic', icon: 'st_athanasius' },
    ...
    // ============================================================
    {
        ...
        copticNext: 'Kiahk',
        synaxarium: [
            '01: Sts. Cosmas & Damian',
            '04: St. Philopater Mercurius (Abu Sefein)',
        ...
        feasts: [
            { day: 1, type: 'c', name: 'Sts. Cosmas & Damian', icon: 'sts_cosmas_damian' },
            { day: 4, type: 'c', name: 'St. Philopater Mercurius', icon: 'st_mercurius' },
...
const FEAST_STYLES = {
    ...
    'P': { bg: 'rgba(109, 40, 217, 0.12)', text: '#4a90c4', label: 'Fast + Feast' },
};
