...
const CALENDAR_DATA = [
    ...
    // ============================================================
    {
        ...
        synaxarium: [
            ...
            '11: Slain Children of Bethlehem',
        ...
        feasts: [
            ...
            { day: 11, type: 'c', name: 'Slain Children of Bethlehem', icon: 'slain_children_bethlehem' },
    ...
    // ============================================================
    {
        ...
        feasts: [
            { day: 1, type: 'c', name: 'St. Mary the Ascetic' },
    ...
    // ============================================================
    {
        ...
        feasts: [
            ...
            { day: 9, type: 'c', name: 'St. Simon Stylite' },
            { day: 13, type: 'c', name: 'Pope Timothy II', icon: 'pope_timothy_ii' },
            { day: 16, type: 'c', name: 'St. Matra' },
            ...
            { day: 23, type: 'c', name: 'St. James the Soldier' },
            { day: 28, type: 'c', name: 'St. Augustine of Hippo', icon: 'st_augustine' },
            { day: 30, type: 'c', name: 'St. Takla Haymanot' },
        ],
        excludeMonthly: 0
    },
    // ============================================================
    ...
    // ============================================================
    {
        ...
        fastingTip: null,
        feasts: [
            { day: 4, type: 'c', name: 'St. Gregory the Ascetic' },
    ...
    // ============================================================
    {
        ...
        feasts: [
            ...
            { day: 8, type: 'c', name: 'St. Demetrius of Thessalonica' },
            { day: 14, type: 'c', name: 'St. Simon the Tanner', icon: 'st_simon_tanner' },
            { day: 15, type: 'c', name: 'St. Felix, Pope of Rome' },
            { day: 18, type: 'c', name: 'Council of Nicaea (325 AD)', icon: 'council_nicaea' },
            { day: 22, type: 'c', name: 'St. Timothy, Bishop of Ansena' },
            ...
            { day: 29, type: 'c', name: 'St. Anianus, 2nd Pope' },
        ],
        excludeMonthly: 0
    },
    // ============================================================
    ...
    // ============================================================
    {
        ...
        feasts: [
            ...
            { day: 6, type: 'c', name: 'St. James the Mangled' },
